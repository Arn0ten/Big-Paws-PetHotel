...
import { Facebook, Instagram, Github, Mail, MessageCircle, X } from "lucide-react"
    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Luxury accommodations for your pets while you're away. We provide comfortable kennels, regular exercise, and
          personalized care.
        </p>
      </div>
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Professional grooming services including bathing, haircuts, nail trimming, and more to keep your pet looking
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Supervised play and socialization for your pet during the day. Perfect for busy pet owners who want their pets
          to have company.
        </p>
      </div>
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          In-home pet care services including feeding, walking, medication administration, and more for pets who prefer
          staying at home.
        </p>
      </div>
    </div>
  ...
  const supportContent = (
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Detailed information about our pricing plans and options for all services.
        </p>
      </div>
      <div className="space-y-2">
        <h3 className="text-lg font-medium">Documentation</h3>
        <p className="text-muted-foreground">
          Comprehensive guides and documentation for pet owners about our services and facilities.
        </p>
      </div>
      <div className="space-y-2">
        <h3 className="text-lg font-medium">Guides</h3>
        <p className="text-muted-foreground">
          Step-by-step guides for preparing your pet for boarding, grooming, and other services.
        </p>
      </div>
      <div className="space-y-2">
        <h3 className="text-lg font-medium">FAQ</h3>
        <p className="text-muted-foreground">
          Answers to frequently asked questions about our services, policies, and procedures.
        </p>
      </div>
    </div>
  )
  ...
  const companyContent = (
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Learn about our company's history, mission, and values. Big Paws Pet Hotel has been providing exceptional pet
          care since 2020.
        </p>
      </div>
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Read our latest articles on pet care, health tips, and industry news to keep your furry friends happy and
          healthy.
        </p>
      </div>
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Join our team of passionate pet care professionals. View current job openings and application information.
        </p>
      </div>
      <div className="space-y-2">
        <h3 className="text-lg font-medium">Press</h3>
        <p className="text-muted-foreground">
          Media resources, press releases, and news about Big Paws Pet Hotel's growth and achievements.
        </p>
      </div>
    </div>
  )
  ...
  const helpContent = (
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Our support team is available 7 days a week from 8am to 8pm. Contact us by phone at +63 950 189 0933 or email
          at support@bigpawspethotel.com.
        </p>
      </div>
      <div className="space-y-2">
        <h3 className="text-lg font-medium">Emergency Services</h3>
        <p className="text-muted-foreground">
          For pet emergencies outside of business hours, please call our 24/7 emergency line at +63 950 189 0934.
        </p>
      </div>
      <div className="space-y-2">
        <h3 className="text-lg font-medium">Feedback</h3>
        <p className="text-muted-foreground">
          We value your feedback! Let us know how we can improve our services to better serve you and your pets.
        </p>
      </div>
    </div>
  )
    ...
    <footer className="bg-background border-t border-border">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-base text-muted-foreground">
              Providing luxury pet care services with love and dedication since 2020.
            </p>
            <div className="flex space-x-6">
              ...
              <a href="mailto:contact@bigpawspethotel.com" className="text-muted-foreground hover:text-foreground">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <button
                      onClick={() => openDialog("Pet Hotel Services", servicesContent)}
                  ...
                  <li>
                    <button
                      onClick={() => openDialog("Grooming Services", servicesContent)}
                      className="text-base text-muted-foreground hover:text-foreground"
                    >
                      Grooming
                    </button>
                  ...
                  <li>
                    <button
                      onClick={() => openDialog("Day Care Services", servicesContent)}
                      className="text-base text-muted-foreground hover:text-foreground"
                    >
                      Day Care
                    </button>
                  ...
                  <li>
                    <button
                      onClick={() => openDialog("Home Services", servicesContent)}
                      className="text-base text-muted-foreground hover:text-foreground"
                    >
                      Home Services
                    </button>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <button
                      onClick={() => openDialog("Pricing Information", supportContent)}
                      className="text-base text-muted-foreground hover:text-foreground"
                    >
                      Pricing
                    </button>
                  ...
                  <li>
                    <button
                      onClick={() => openDialog("Documentation", supportContent)}
                      className="text-base text-muted-foreground hover:text-foreground"
                    >
                      Documentation
                    </button>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <button
                      onClick={() => openDialog("About Big Paws Pet Hotel", companyContent)}
                      className="text-base text-muted-foreground hover:text-foreground"
                    >
                      About
                    </button>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <button
                      onClick={() => openDialog("Terms of Service", legalContent)}
                      className="text-base text-muted-foreground hover:text-foreground"
                    >
                      Terms
                    </button>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="max-h-[60vh] overflow-y-auto pr-1">{dialogContent.content}</div>
        </DialogContent>
      </Dialog>
    </footer>
  )
