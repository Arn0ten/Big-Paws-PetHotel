...
export default function MapComponent({ userLocation, petHotelLocation, route, setUserLocation }: MapComponentProps) {
  useEffect(() => {
  ...
  return (
    <MapContainer center={petHotelLocation} zoom={13} style={{ height: "100%", width: "100%" }}>
      <TileLayer
