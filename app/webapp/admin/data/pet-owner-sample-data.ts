/**
 * PET OWNER MANAGEMENT SAMPLE DATA
 *
  ...
  "P-006": [
    {
      ...
      status: "active",
      type: "LongStay",
      notes: "Currently boarding, special diet maintained",
      totalPrice: 2800,
      paymentStatus: "Paid",
    },
  ],
  ...
  "P-006": [
    {
      ...
      type: "photo",
      status: "completed",
      notes: "Daily photo update of Bella during boarding",
      price: null,
      paymentStatus: "N/A",
    },
    {
      ...
      type: "grooming",
      status: "completed",
      notes: "Basic grooming with special attention to ears",
      price: 300,
      paymentStatus: "Paid",
    },
  ],
