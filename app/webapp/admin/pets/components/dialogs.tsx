...
import { PlusCircle, Loader2, Dog, Cat, AlertCircle, PawPrint, User } from "lucide-react"
...
export function EditPetDialog({ pet, isOpen, onOpenChange, onSubmit, isSubmitting, petOwners }: EditPetDialogProps) {
  ...
  const validateForm = useCallback(() => {
    const errors: FormErrors = {}
    const requiredFields: (keyof Pet)[] = ["name", "type", "breed", "age", "size", "ownerId"]
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="w-full max-w-md md:max-w-lg p-4 md:p-6 overflow-y-auto max-h-[80vh]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
          <div className="space-y-2">
            <Label htmlFor="edit-pet-name" className="text-sm font-medium flex items-center">
              Pet Name <span className="text-red-500 ml-1">*</span>
            </Label>
            <Input
              id="edit-pet-name"
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-pet-owner" className="text-sm font-medium flex items-center">
              Pet Owner <span className="text-red-500 ml-1">*</span>
            </Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-pet-type" className="text-sm font-medium flex items-center">
              Pet Type <span className="text-red-500 ml-1">*</span>
            </Label>
            <Select value={formState.type} onValueChange={(value) => updateField("type", value)}>
              <SelectTrigger
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-pet-breed" className="text-sm font-medium flex items-center">
              Breed <span className="text-red-500 ml-1">*</span>
            </Label>
            <Select value={formState.breed} onValueChange={(value) => updateField("breed", value)}>
              <SelectTrigger
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-pet-age" className="text-sm font-medium flex items-center">
              Age (years) <span className="text-red-500 ml-1">*</span>
            </Label>
            <Input
              id="edit-pet-age"
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-pet-size" className="text-sm font-medium flex items-center">
              Size <span className="text-red-500 ml-1">*</span>
            </Label>
            <Select value={formState.size} onValueChange={(value) => updateField("size", value)}>
              <SelectTrigger
