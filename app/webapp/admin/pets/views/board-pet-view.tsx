...
const dogDaycarePricing: PricingMap = {
    Small: 25,
    Medium: 30,
    Large: 40,
    XL: 50,
...
const dogAccommodationPricing: PricingMap = {
    Small: 320,
    Medium: 400,
    Large: 480,
    XL: 550,
...
const calculateBoardingPrice = (
    ...
    if (pet.animal === "Dog") {
        if (type === "DAYCARE") {
            ...
            const hourlyRate = dogDaycarePricing[pet.size as PetSize || "Medium"];
            ...
            const dailyRate = dogAccommodationPricing[pet.size as PetSize || "Medium"];
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <div
                                    className={`flex items-center space-x-3 p-3 rounded-lg border transition-colors ${
                                        boardingDetails.type === "LONG_STAY"
                                            ? "border-primary bg-primary/10 shadow-sm"
                                            : "hover:bg-muted/50 border-border"
                                    }`}
                                >
