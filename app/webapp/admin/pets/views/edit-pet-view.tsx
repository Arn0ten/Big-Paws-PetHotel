 ...
 * Edit Pet View
 *
 * This view is used for editing an existing pet's information.
 *
...
import { PawPrint, Dog, Cat, Upload, User, Loader2 } from "lucide-react"
...
export default function EditPetView({ pet, petOwners, onBack, onCancel, onSubmit, isSubmitting }: EditPetViewProps) {
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              disabled={true} // Disable changing owner in edit mode
            >
              <SelectTrigger
                id="pet-owner"
