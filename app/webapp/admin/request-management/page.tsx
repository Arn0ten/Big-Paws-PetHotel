...
import { CheckCircle, Search, Filter, Loader2, RefreshCw, Calendar, ArrowUpDown } from "lucide-react"
...
import { UndoAcceptDialog } from "./components/undo-accept-dialog"
...
export default function RequestManagementPage() {
  ...
  const confirmUndoAccept = () => {
    ...
    setTimeout(() => {
      ...
      updateRequest(requestToUndo.id, {
        ...
        _previousData: {
          status: requestToUndo.status,
          processingNotes: requestToUndo.processingNotes,
        },
      })
  ...
  return (
    <div className="space-y-6">
      ...
      <UndoAcceptDialog
        ...
        undoAcceptMessage={undoAcceptMessage}
        setUndoAcceptMessage={setUndoAcceptMessage}
        isProcessing={isProcessing}
        onConfirm={confirmUndoAccept}
        isMobile={isMobile}
      />
    </div>
  )
