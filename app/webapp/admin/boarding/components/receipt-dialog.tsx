      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto dark:bg-gray-900">
        <DialogHeader className="flex flex-row items-center">
          {showBackButton && (
            <Button
              ...
              aria-label="Back to boarding details"
            >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border p-4 shadow-sm relative overflow-hidden">
          ...
          <div className="text-center mt-4 text-xs text-muted-foreground">
            Big Paws Pet Hotel • Bonifacio St., in front of Philhealth, Tagum
            City, Philippines, 8100 • galojanlloyn18@gmail.com • +63 950 189
            0933
          </div>
        </div>
