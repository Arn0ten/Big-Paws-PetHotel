...
import { ChevronLeft, ChevronRight, LogOut, Menu, PawPrint } from "lucide-react"
    ...
    <>
      ...
      {isMobile && !isMobileMenuOpen && (
        <Button
          variant="ghost"
          size="icon"
          className="fixed left-4 top-3 z-50 text-foreground hover:bg-foreground/10"
          onClick={() => {
