...
import { Dog, Cat, Upload, Loader2, PlusCircle } from "lucide-react"
...
export default function AddPetView({ ownerId, ownerName, onBack, onSubmit, isSubmitting }: AddPetViewProps) {
