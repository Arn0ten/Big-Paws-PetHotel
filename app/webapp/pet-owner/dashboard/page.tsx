...
const mockUserData = {
  ...
  upcomingBookings: [
    { id: 1, petName: "Buddy", petType: "Dog", service: "Boarding", date: "2023-06-15" },
    { id: 2, petName: "Whiskers", petType: "Cat", service: "Grooming", date: "2023-06-20" },
  ],
}
                  ...
                  <CardContent className="flex items-center space-x-4 p-6">
                    <div className="flex-shrink-0">
                      <Avatar className="w-16 h-16">
                        <AvatarImage
                          src={pet.type.toLowerCase() === "cat" ? DEFAULT_CAT_AVATAR : DEFAULT_DOG_AVATAR}
                          alt={pet.name}
                        />
                  ...
                  <CardContent className="flex items-center justify-between p-6">
                    <div className="flex items-center space-x-4">
                      <Avatar className="h-10 w-10">
                        <AvatarImage src={getPetAvatar(booking.petName, booking.petType)} alt={booking.petName} />
