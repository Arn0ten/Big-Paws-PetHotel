          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-sm text-blue-700 dark:text-blue-300">
                <span className="font-medium">Suggested next steps:</span> Check your pet's boarding status, make a new
                request, or view our pricing page for service rates.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="mt-4 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-md">
                ...
                <div className="mt-2">
                  <Link
                    ...
                    className="text-xs text-primary dark:text-primary-foreground hover:underline inline-flex items-center"
                  >
      ...
      >
        <Tabs defaultValue="boarding" value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="requests" className="text-foreground dark:text-foreground">
              Recent Requests
            </TabsTrigger>
          </TabsList>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        {pet.boarding ? (
                          <Badge className="mt-2 bg-green-600 text-white">Currently Boarding</Badge>
                        ) : (
                          <Badge className="mt-2 bg-gray-600 text-white">Not Boarding</Badge>
                        )}
                      </div>
