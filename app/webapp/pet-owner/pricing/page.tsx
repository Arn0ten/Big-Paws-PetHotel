...
export default function PricingPage() {
  ...
  const [activeTab, setActiveTab] = useState<"boarding" | "grooming">(
    "boarding",
  );
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            View our rates for boarding and other services
          </p>
        </div>
      </div>
          ...
          <TabsContent value="boarding" className="mt-6 space-y-6">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                        <strong>Standard:</strong> Includes comfortable
                        accommodation, regular feeding, and daily walks.
                      </p>
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                        <strong>Premium:</strong> Includes all standard features
                        plus premium food, extra playtime, daily grooming, and
                        photo updates.
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-6 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                        All cat boarding includes comfortable accommodation,
                        regular feeding, litter box maintenance, and playtime.
                      </p>
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                        Cats from the same household can share a room for an
                        additional fee.
                      </p>
                    </div>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  For pets not staying overnight
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                ...
                <div className="mt-6 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                        Day care is available from 8:00 AM to 7:00 PM daily. All
                        pets must be fully vaccinated and have anti-rabies
                        shots.
                      </p>
                    </div>
                  </div>
          ...
          <TabsContent value="grooming" className="mt-6 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select your pet size to view pricing
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {Object.entries(petSizes).map(
                    ([size, description], index) => {
                      ...
                      const basicWashPrice =
                        PRICING.grooming["basic-wash"]?.[
                          size as keyof typeof petSizes
                        ] || 180 + index * 40;

                      const premiumWashAndCutPrice =
                        PRICING.grooming["premium-wash-and-cut"]?.[
                          size as keyof typeof petSizes
                        ] || 450 + index * 50;
                      ...
                      return (
                        <div key={size} className="space-y-3">
                          <div className="flex justify-between items-center">
                            <h3 className="font-medium text-foreground dark:text-foreground capitalize">
                              {size}
                            </h3>
                            <Badge className="bg-blue-600 text-white">
                              {description}
