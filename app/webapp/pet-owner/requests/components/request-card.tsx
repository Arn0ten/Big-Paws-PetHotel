  ...
  return (
    <>
      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} transition={{ duration: 0.2 }}>
        <Card
          className={`cursor-pointer overflow-hidden ${getCardBorderColor(request.status)}`}
        ...
        >
          <CardHeader className="p-4 pb-2 flex flex-row items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h3 className="font-medium text-sm">{getRequestTypeLabel(request.type)}</h3>
          ...
          <CardFooter className="p-4 pt-0 flex justify-between items-center">
            <div>
              ...
              <p className="text-xs font-medium">{getTimeAgo(request.createdAt)}</p>
            </div>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-1">
              ...
              <div className="text-sm font-medium p-3 bg-muted/30 rounded-md">{request.description}</div>
            </div>
            ...
            {request.completedAt && (
              <div className="space-y-1">
                ...
                <div className="text-sm font-medium">{formatDate(request.completedAt)}</div>
              </div>
            )}
