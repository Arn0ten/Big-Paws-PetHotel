  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6">
        ...
        >
          {/* Welcome Banner */}
          <div className="relative h-48 w-full rounded-t-2xl overflow-hidden mb-8">
            <Image
            ...
            />
            <div className="absolute inset-0 bg-primary/60 dark:bg-primary/70 flex items-center justify-center">
              <motion.div
              ...
              >
                <h1 className="text-white text-3xl sm:text-4xl font-bold">Welcome to Big Paws Pet Hotel</h1>
                <p className="text-white/90 mt-4 max-w-2xl mx-auto text-lg">Your pet's home away from home</p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-foreground mb-4">Pet Management Portal</h2>
            <p className="text-muted-foreground mx-auto text-lg mb-8">
              Access your pet's information, view their stay history, and manage your account.
            </p>

            <Button size="lg" className="w-full mb-4" onClick={handleLogin} disabled={isLoading}>
              {isLoading ? (
                <>
