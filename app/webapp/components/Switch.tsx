 ...
 * Switch Component
 *
 * This component provides a toggle switch for boolean values.
 * It is used for notification preferences and other boolean settings.
 *
 * BACKEND INTEGRATION:
 * When using this component for user preferences, ensure that the onChange
 * handler makes an API call to update the user's preferences in the database.
 */
