...
import {login, loginWithEmail, loginWithPhoneNumber} from "@/app/webapp/auth/pet-owner/services/authService";
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (/^\d{10}$/.test(formData.username)) {
                // It's a 10-digit number — assume phone number
                console.log("Username is a phone number");
                const response = await loginWithPhoneNumber(formData.username, formData.password);
                ...
                const response = await loginWithEmail(formData.username, formData.password)
            ...
            <main className="flex-grow bg-background py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
                    <div className="prose prose-lg dark:prose-invert max-w-none">
                        ...
                        <div
                            className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg mb-8 border border-blue-200 dark:border-blue-800">
                            <p className="flex items-start">
                                <AlertTriangle
                                    className="h-5 w-5 mr-2 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-1"/>
                                <span>
