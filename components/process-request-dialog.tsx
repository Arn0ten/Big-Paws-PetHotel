...
export function ProcessRequestDialog({ open, onOpenChange, request, onSuccess }: ProcessRequestDialogProps) {
        ...
        <div className="grid gap-4 py-4">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {groomingDate ? format(groomingDate, "PPP") : "Select a date"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0">
                  <Calendar mode="single" selected={groomingDate} onSelect={setGroomingDate} initialFocus />
                </PopoverContent>
              </Popover>
            </div>
          )}
          ...
          {details && (
            <EmailPreview
              ...
              extensionDays={showExtensionDays && extensionDays ? Number.parseInt(extensionDays, 10) : undefined}
              groomingDate={showGroomingDate && groomingDate ? format(groomingDate, "MMMM dd, yyyy") : undefined}
            />
          )}
        </div>
